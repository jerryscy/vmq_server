...
cipher_ci_transform(KeyEx, ["AES128", "GCM"|Rest]) ->
    cipher_hash_transform(KeyEx, aes_128_gcm, Rest);
cipher_ci_transform(KeyEx, ["AES256", "GCM"|Rest]) ->
    cipher_hash_transform(KeyEx, aes_256_gcm, Rest);
